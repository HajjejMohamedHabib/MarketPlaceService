 ...
 */
final class Version20241013000234 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F5299398ED5CA9E6 ON `order`');
        $this->addSql('ALTER TABLE `order` DROP service_id');
    }
}
